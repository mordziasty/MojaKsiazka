...
@EActivity(R.layout.activity_rejestracja)
public class Rejestracja extends ActionBarActivity {


    public void registerSuccess(User user){                    // void nic nie zwraca tylko wywoluje
    ...
    @NonConfigurationInstance                           // nie wywali apki po obroceniu ekranu
            RejestracjaBackgroundTask rejestracjaBackgroundTask;        // tworzy sie nowy obiekt
    ...
    void ZarejestrujButtonClicked(){
        ...
        rejestracjaBackgroundTask.rejestracja(registration);
    }
}